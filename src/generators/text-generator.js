...
반드시 JSON만 출력 (다른 텍스트 없이):
{
  ...
  "slides": [
    ...
    { "slideNum": 3, "category": "...", "title": "...", "body": "...", "keyPoints": ["...", "..."], "source": "...", "imageKeyword": "..." },
    { "slideNum": 4, "category": "...", "title": "...", "body": "...", "keyPoints": ["...", "..."], "source": "...", "imageKeyword": "..." },
    { "slideNum": 5, "category": "...", "title": "...", "body": "...", "keyPoints": ["...", "..."], "source": "...", "imageKeyword": "..." },
    { "slideNum": 6, "category": "...", "title": "...", "body": "...", "keyPoints": ["...", "..."], "source": "...", "imageKeyword": "..." }
  ],
